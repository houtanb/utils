...
OAI_MODEL_RUNS: list[ModelRun] = [
    ...
    _model_run(
        model_run_key="gpt-6-luna-run-variant-01",
        slug="gpt-6-luna-standard-high-web-search",
    ...
    _model_run(
        model_run_key="gpt-6-sol-run-variant-01",
        slug="gpt-6-sol-standard-high-web-search",
        model_key="gpt-6-sol",
        options={
            "reasoning": {
                "mode": "standard",
...
XAI_MODEL_RUNS: list[ModelRun] = [
    ...
    _model_run(
        model_run_key="grok-4.7-run-variant-01",
        slug="grok-4.7-xhigh-web-x-search",
        model_key="grok-4.7",
        options={
            "reasoning": {"effort": "xhigh"},
            "tools": [{"type": "web_search"}, {"type": "x_search"}],
